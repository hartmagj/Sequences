...
def run_test_sum_sequence():
    ...
    # ------------------------------------------------------------------
    # d: 2. READ the COMMENTS and CODE in this function,
...
def run_test_count_items_bigger_than():
    ...
    # ------------------------------------------------------------------
    # d: 4. Implement this TEST function.
...
def run_test_count_positive_sines():
    ...
    # ------------------------------------------------------------------
    # d: 6. Implement this TEST function.
...
def count_positive_sines(numbers):
    ...
    """
    # ------------------------------------------------------------------
    # d: 7. Implement and test this function.
    #   Note that you should write its TEST function first (above).
    # ------------------------------------------------------------------
...
def run_test_sum_first_n():
    ...
    # ------------------------------------------------------------------
    # d: 8. Implement this TEST function.
    ...
    expected = 2
    actual = sum_first_n([2, 3, 4, 3], 1)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)

    expected = 5
    actual = sum_first_n([2, 3, 4, 3], 2)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
...
def sum_first_n(numbers, n):
    ...
    """
    # ------------------------------------------------------------------
    # d: 9. Implement and test this function.
    #          Tests have been written for you (above).
    #
    # RESTRICTION:
    #    You may NOT use the built-in  sum   function
